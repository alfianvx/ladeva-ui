  ...
  return (
    <React.Fragment>
      {highlightedReviews?.map((review) => (
        ...
        >
          <p className="text-base subpixel-antialiased font-bold text-white md:text-lg">
            &quot; {review.message} &quot;
          </p>
        ...
        {reviews?.data
          ...
          .map((review) => (
            <div key={review.id} className="w-full p-5 border rounded-lg">
              <p className="text-base font-bold subpixel-antialiased md:text-lg">
                &quot; {review.message} &quot;
              </p>
              <div className="flex items-center justify-between pt-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-base font-medium">{review.name}</h4>
