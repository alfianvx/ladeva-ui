...
export default function Workflow() {
  return (
    <section
      id="how-it-work"
      className="flex flex-col items-center justify-center px-5 mx-auto my-14 md:my-20 md:px-0 max-w-7xl scroll-m-32"
    >
  ...
  rounded-lg col-span-1 flex items-center justify-center w-auto h-40 md:h-auto"
        >
          <span className="text-xl font-medium text-white">Any Question?</span>
        </Link>
      </div>
    </section>
  );
